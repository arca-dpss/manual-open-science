...
- In Chapter \@ref(git-chapter), we introduce Git, a software for tracking changes in any file during the development of our project.
...
- In Chapter \@ref(dynamic-documents-chapter) [work in progress], we introduce the main tools to create dynamic documents that integrate narrative text and code describing the advantages.
...
<!-- cumulating articles and citation is what moves your career but cumulating data is what moves science -->
