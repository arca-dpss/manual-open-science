...
Once the working directory is correctly set (automatically or manually), relative paths will work on any computer (up to the operating system; see [*“Details-Box: The Garden of Forking Paths”*](#garden-forking-paths) below). This is one of the great advantages of using projects and relative paths: all the files are referred to relative to the project structure and independently of the specific computer directories configuration.

[TODO: check paths windows]

<a name="garden-forking-paths"></a>
