...
A directory in which to store all the data used in the analysis. These files should be considered `read-only`. In the case of analyses that required some preprocessing of the data, it is important to include both the raw data and the actual data used in the analysis. 
...
:::{.design title="Garden of Forking Paths" data-latex="[Garden of Forking Paths]"}
