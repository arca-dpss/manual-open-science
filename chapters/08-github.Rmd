...
Finally, note that, even if we do not have any collaborator on a project, we could still use a remote repository on GitHub as a personal backup or to share the project results with the whole community.
