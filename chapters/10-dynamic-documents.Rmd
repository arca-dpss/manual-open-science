...
One of the authors of this book is also the maintainer of the `trackdown` R package. `trackdown` [@R-trackdown] offers a simple solution for collaborative writing and editing of R Markdown (or Sweave) documents. Using  `trackdown`, we can upload the local `.Rmd` (or `.Rnw`) file as a plain-text file to Google Drive. 
